        ...
        child: Obx(() {
           ...
           return ListView(
             children: [
              ...
              Padding(
                padding: EdgeInsets.symmetric(vertical: 3.0.wp,horizontal: 4.9.wp),
                 ...
                 child: SizedBox(width: 70.0.wp, height: 70.0.wp,child: CircularStepProgressIndicator(
                   ...
                   Column(
                     ...
                     children: [
                       ...
                       Text('Efficiency',style: TextStyle(color: Colors.grey,fontWeight: FontWeight.bold,fontSize: 12.0.sp),)
                     ],
